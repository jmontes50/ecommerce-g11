    ...
    <div className="navbar bg-base-100 border-b">
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown lg:hidden">
          ...
          <div tabIndex={0} role="button" className="btn btn-ghost btn-square" aria-label="Abrir menú">
      ...
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          ...
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar placeholder" aria-label="Abrir opciones de usuario">
